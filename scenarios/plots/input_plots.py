...
def read_data(year):
    scenario_power_syst_data = pathlib.Path(f"scenarios/data/nordic/data_{year}")
    file_storval_filling = pathlib.Path(f"scenarios/data/nordic/data_storagevalues/profiles_storval_filling.csv")
    file_30y_profiles = pathlib.Path(f"scenarios/data/nordic/data_timeseries/timeseries_profiles/timeseries_profiles.csv")
    ...
    powerplants = pd.read_csv(f"scenarios/data/All_powerplant_powerplantmatching.csv")
